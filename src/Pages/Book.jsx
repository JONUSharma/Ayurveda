...
export default function Book() {
  ...
  return (
    <div className="max-w-3xl mx-auto p-6">
      <h1 className="text-4xl text-green-800 font-bold mb-6 text-center">Book Your Treatment</h1>
      ...
      {submitted ? (
        ...
        <form onSubmit={handleSubmit} className="bg-green-50 p-6 rounded-lg shadow space-y-4">
          ...
          <div>
            <label className="block text-green-800 font-medium mb-1">Treatment Type *</label>
            <select
              name="treatment"
          ...
          <div>
            <label className="block text-green-800 font-medium mb-1">Preferred Date & Time *</label>
            <input
              type="datetime-local"
              name="date"
              value={formData.date}
